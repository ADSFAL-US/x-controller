"""Тест авто-селекта для финских и голландских STABLE конфигураций.

Тестирует интеграцию авто-селекта в систему подписок с поддержкой JSON формата
для Happ/Incognito/v2rayTun клиентов.
"""
import base64
import json
import sys
...
def test_finnish_dutch_stable():
    """Тестирует авто-селект для финских и голландских STABLE конфигураций."""
    print("=== Тест авто-селекта для финских и голландских STABLE конфигураций ===\n")
    ...
    with open('test_finnish_dutch_output.json', 'w', encoding='utf-8') as f:
        json.dump(profiles, f, ensure_ascii=False, indent=2)
    print(f"\nРезультат сохранён в test_finnish_dutch_output.json")
    ...
    print(f"\n✅ Тест финско-голландских STABLE конфигураций пройден!")
    return True

if __name__ == '__main__':
    try:
        test_finnish_dutch_stable()
        sys.exit(0)
